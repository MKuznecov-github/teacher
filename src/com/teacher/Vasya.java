...
class DerevoFrameEdit extends JFrame {
    ...
    public TreeNode makeSampleDerevo() {
        ...
        country.add(city);
        country = new DefaultMutableTreeNode("Украина");
        root.add(country);
        city = new DefaultMutableTreeNode("Киев");
        country.add(city);
        country = new DefaultMutableTreeNode("Англия");
        root.add(country);
        city = new DefaultMutableTreeNode("Лондон");
        country.add(city);
        return root;
    }
    public void makeButtons() {
        ...
        addSiblingButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                DefaultMutableTreeNode newNode = new DefaultMutableTreeNode("Страна");
        ...
        JButton addChildButton = new JButton("Добавить Город");
        addChildButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                DefaultMutableTreeNode newNode = new DefaultMutableTreeNode("Город");
